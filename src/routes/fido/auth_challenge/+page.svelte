    ...
    <Col md="6">
      <Card class="shadow-sm border-0">
        <CardHeader class="bg-teal text-white py-2">
          <h6 class="mb-0 fw-bold"><i class="bi bi-fingerprint me-2"></i>Auth Challenge リクエスト設定</h6>
        </CardHeader>
        <CardBody>
          <div class="mb-3">
          ...
          <div class="mb-3 pb-2 border-bottom">
            <h6 class="text-teal small fw-bold mb-1">
          ...
          <div class="mb-3">
            <h6 class="text-teal mb-1 small fw-bold"><i class="bi bi-server me-1"></i>RPサーバー設定</h6>
            <SelectArrayText2 bind:presets={serverPresets} bind:selectedLabel={serverState.value} />
          </div>

          <div class="mb-3">
            <h6 class="text-teal mb-1 small fw-bold"><i class="bi bi-person-badge me-1"></i>クライアント設定</h6>
          ...
          <div class="mb-1">
            <h6 class="text-teal mb-1 small fw-bold"><i class="bi bi-gear-fill me-1"></i>Static設定 (共通変数)</h6>
        ...
        <CardBody class="bg-light p-3 font-monospace">
          {#if selectedApi}
            ...
            <div class="d-grid mt-4">
              <Button class="btn-teal btn-lg fw-bold shadow" onclick={handleExecute}>
                <i class="bi bi-lightning-fill me-2"></i>Auth Challenge 取得実行
              </Button>
            </div>
          {:else}
...
<style>
  /* 認証(Auth)用テーマカラー (Teal) */
  :global(.bg-teal) { background-color: #20c997 !important; }
  :global(.text-teal) { color: #20c997 !important; }
  :global(.btn-teal) { background-color: #20c997 !important; color: white !important; }
